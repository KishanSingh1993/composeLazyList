package `in`.eduforyou.composelazylist.welcome
...
import `in`.eduforyou.composelazylist.R
import `in`.eduforyou.composelazylist.pictureList
import `in`.eduforyou.composelazylist.ui.theme.AppTheme
